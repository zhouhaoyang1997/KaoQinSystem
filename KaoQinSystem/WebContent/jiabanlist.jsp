...
<form action="AdvancedSearch?name=QianDao&path=jiaban" method="post">
  ...
  <tr> 
    ...
    <td nowrap class="td_top">上班时间</td>
    <td nowrap class="td_top">下班时间</td>
    <td nowrap class="td_top">员工编号</td>
    <td nowrap class="td_top"></td>
    <td nowrap class="td_top">状态</td>
    <td nowrap class="td_top"></td>
  </tr>
   <c:forEach items="${list}" var="jiaban" varStatus="i">
  
  <tr> 
    <td class="td_01">${user.uname }</td>
    <td class="td_01">${jiaban.starttime}</td>
    <td class="td_01">${jiaban.endtime2 }</td>
    <td class="td_01">${jiaban.uid}</td>
    <td class="td_01"></td>
    <td class="td_01">${jiaban.description}</td>
    <td class="td_01"></td>
  </tr>
 </c:forEach>
</table>
