...
<body class="main">
								<form action="../CreatKaoQinRule" method="post" name="form" onsubmit="javascript:return checkform();">
					
									<table width="100%" border="0" cellspacing="5" class="upline"  >
										<tr>
											<td colspan="4" height="80" style="font-size: 50; font-family: '楷体';;"align="center"><p style="margin-left: -15%;">考勤制度发布</p></td>
										</tr>
										<tr height="34">
