	...
	<div id="divpagecontent">
									...
									<table width="100%" border="0" cellspacing="5" class="upline"  >
										...
										<tr height="34">
											...
											<td style="width:20%; padding-left:20px">${user.uname}</td>
											<td style="text-align:center; width:25%">工号：</td>
											<td style="width:50%; padding-left:20px">${user.uid}</td>
										</tr>
										<tr height="34">
											<td style="text-align:center">性别：</td>
											<td style="padding-left:20px">${user.usex}</td>
											<td style="text-align:center">职位：</td>
											<td style="padding-left:20px">${user.uwork}</td>
										</tr>
										<tr height="34">
											<td style="text-align:center">入职时间：</td>
											<td style="padding-left:20px">${user.uentrytime}</td>
											<td style="text-align:center">上级领导：</td>
											<td style="padding-left:20px">${user.uboss}</td>
										</tr>
										<tr height="34">
											<td style="text-align:center">部门编号：</td>
											<td style="padding-left:20px">${user.udepartid}</td>
											<td style="text-align:center">部门：</td>
											<td style="padding-left:20px">${user.udepartname}</td>
										</tr>
										<tr height="34"> 
											<td style="text-align:center">联系方式：</td>
											<td style="padding-left:20px">${user.utel}</td>
											<td style="text-align:center">邮箱地址：</td>
											<td style="padding-left:20px">${user.umail}</td>
										</tr>
										<tr height="25">
											<td style="text-align:center">地址：</td>
											<td style="padding-left:20px" colspan="3">${user.uaddr}</td>
										</tr>
									</table>
